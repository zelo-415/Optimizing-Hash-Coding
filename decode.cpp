...
/* INSERT YOUR CODE FROM HERE */  
  else if(funct7 == 2)
    {
      ...
      if (funct3 == 5) return instTable_.getEntry(InstId::extend1);
      if (funct3 == 6) return instTable_.getEntry(InstId::extend2);
      if (funct3 == 7) return instTable_.getEntry(InstId::extend3);
    }
