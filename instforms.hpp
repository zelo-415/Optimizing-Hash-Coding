...
/* INSERT YOUR CODE FROM HERE */
    ...
    bool encodeExtend1(unsigned rd, unsigned rs1, unsigned rs2);
    
    
    bool encodeExtend2(unsigned rd, unsigned rs1, unsigned rs2);
    
    
    bool encodeExtend3(unsigned rd, unsigned rs1, unsigned rs2);
